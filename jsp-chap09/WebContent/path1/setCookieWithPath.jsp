...
<%
	Cookie cookie1 = new Cookie("path1", 
			URLEncoder.encode("경로:/jsp-chap09/path1", "utf-8"));
	cookie1.setPath("/jsp-chap09/path1");
	...
	Cookie cookie4 = new Cookie("path4", 
			URLEncoder.encode("경로:/jsp-chap09/path2", "utf-8"));
	cookie4.setPath("/jsp-chap09/path2");
