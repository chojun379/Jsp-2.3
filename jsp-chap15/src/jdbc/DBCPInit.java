...
public class DBCPInit extends HttpServlet {
	...
	private void initConnectionPool() {
		try {
			String jdbcUrl = "jdbc:mysql://localhost:3306/jsp?useUnicode=true&characterEncoding=utf8&serverTimezone=UTC";
			String username = "chojun";
			String pw = "wkzt9q";
			...
			driver.registerPool("jsp", connectionPool);
		} catch(Exception e) {
